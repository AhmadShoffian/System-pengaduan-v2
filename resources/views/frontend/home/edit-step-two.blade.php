...
<body class="bg-gray-100 py-10">
    ...
    <div class="w-full max-w-4xl mx-auto">
        <form action="{{ route('pengaduan.create.step.two.post') }}" method="POST" class="bg-white rounded-lg shadow-lg">
            @csrf
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="flex gap-3 pt-4">
                    ...
                    <button type="reset"
                        class="border border-cyan-600 text-cyan-600 hover:bg-cyan-50 px-8 py-2 rounded-md">Back</button>
                </div>
        ...
        <div class="w-full max-w-4xl mx-auto">
            ...
            <form action="{{ route('pengaduan.edit.step.three', $pengaduan->id) }}" method="GET"
                ...
                <div class="border-t px-6 py-4 flex justify-end gap-3">
                    ...
                    <button type="submit" class="bg-cyan-600 hover:bg-cyan-700 text-white px-8 py-2 rounded-md shadow">
                        Lanjut
                    </button>
                </div>
            </form>
